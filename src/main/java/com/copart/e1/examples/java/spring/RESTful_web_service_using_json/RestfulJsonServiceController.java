 ...
 *
 */
public class RestfulJsonServiceController 
{
...
*/
	...
	public ResponseDataRecord onPost(@RequestBody RequestDataRecord requestBody)
	{
		...
		ResponseDataRecord responseBody = new ResponseDataRecord();
		
		if(requestBody.firstName == null)
		{
			responseBody.setFavoriteCar("Volkwagen");
			responseBody.setFavoriteColor("purple");
		}
		else
		{
			responseBody.setFavoriteCar("Ferrari");
			responseBody.setFavoriteColor("red");
		}
